...
$( window ).load( function()
{
    ...
    $( window ).load( function()
{
        if(document.getElementsByClassName('indexmenu')[0] != null){
        var gobottom;
    gobottom = function(){document.getElementsByClassName('indexmenu')[0].style.marginTop = window.innerHeight - 90 + "px";};
        gobottom();
    $( window ).resize(gobottom);
    }
});
}
